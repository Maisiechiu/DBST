...
## face detection , transformed imgae , save rawframes2
...
if __name__ == "__main__":
    ...
    video_dirs = [
        "/home/jovyan/dataset/FaceForensics++/manipulated_sequences/Deepfakes/c23/videos" , \
                  ...
                  "/home/jovyan/dataset/FaceForensics++/manipulated_sequences/FaceShifter/c23/videos"
                ]
    ...
    for d1, d2 in test_json:
        test_list.append(d1 + ".mp4")
        test_list.append(d2 + ".mp4")
        test_list.append(d1 + "_" + d2 + ".mp4")
        test_list.append(d2 + "_" + d1 + ".mp4")

    videos = [
        os.path.join(video_dir, vid) for video_dir in video_dirs
        for vid in os.listdir(video_dir) if vid in test_list
    ]
    videos = videos
