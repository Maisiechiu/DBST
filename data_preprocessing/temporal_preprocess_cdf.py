    ...
    with torch.no_grad():
        try:
            ...
            bbox_dir = video.replace("videos",
                                     "rawframes2_test_retina").replace(".mp4", "")
            img_tall_dir = frame_dir.replace("rawframes2_test", "rawframes2_test_tall")
...
if __name__ == "__main__":
    ...
    dataset_path = "/home/jovyan/dataset/Celeb-DF-v2/"
    videos = []
    with open("/home/jovyan/dataset/Celeb-DF-v2/List_of_testing_videos.txt",
              "r") as f:
        for line in f:
            path = line.strip().split(" ")[1]
            forgery_class = path.split('/')[0]
            video_name = path.split('/')[1]
            videos.append(
                os.path.join(dataset_path, forgery_class, "videos",
                             video_name))
